...
namespace xdeequ.tests.Analyzers
{
    ...
    public class MutualInformationAnalyzer
    {
        ...
        public void compute_correct_metrics_missing()
        {
            ...
            DoubleMetricJvm attr1 = MutualInformation(new[] { "att1", "att2" }).Calculate(complete);
            DoubleMetric expected1 = DoubleMetric
                .Create(MetricEntity.Mutlicolumn, "MutualInformation", "att1,att2",
        ...
        public void compute_entropy_for_same_column()
        {
            ...
            DoubleMetricJvm entropyViaMI = MutualInformation(new[] { "att1", "att2" }).Calculate(complete);
            DoubleMetricJvm entropy = Entropy("att1").Calculate(complete);
