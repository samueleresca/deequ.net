...
namespace xdeequ.tests.Constraints
{
    ...
    public class AnalysisBasedConstraintTest
    {
        ...
        public void assert_correctly_on_values_if_analysis_is_successful()
        {
            ...
            var resultA = ConstraintUtils.Calculate<NumMatches, double, double>(
            ...
            var resultB = ConstraintUtils.Calculate<NumMatches, double, double>(
                new AnalysisBasedConstraint<NumMatches, double, double>(
                    new SampleAnalyzer("att1"), _ => _ != 1.0, Option<string>.None), df);
            ...
            var resultC = ConstraintUtils.Calculate<NumMatches, double, double>(
                new AnalysisBasedConstraint<NumMatches, double, double>(
        ...
        public void return_failed_constraint_for_a_failing_assertion()
        {
            ...
            var failingConstraint = new AnalysisBasedConstraint<NumMatches, double, double>(new SampleAnalyzer("att1"),
